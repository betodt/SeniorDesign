...
\section{Conclusion}
As mentioned, current solutions are either too simple, such as to-do applications, or too complex, such as enterprise project management software. Planly targets the middle ground between these two fields, small groups with collaborative projects outside of their full time roles. Planly is simplistic and intuitive web application that provides its users with the essentially organizational tools they need to ensure their projects\textsc{\char13} success. By performing user testing we found that that users enjoyed the simplistic nature of the application. Furthermore, the testing reaffirmed that iterative development allowed for new, useful features to be implemented while improving existing features. Taking what we learned, we are confident that we can continue to enhance the users\textsc{\char13} experience and improve the small group project collaboration.

\begin{thebibliography}{11}

\bibitem{Jugdev} 
Jugdev, K.; Mathur, G.; Tak Fung, ``Project management assets and project management performance: Preliminary findings," in \textit{Technology Management in the Energy Smart World (PICMET), 2011 Proceedings of PICMET '11:} , vol., no., pp.1-7, July 31 2011-Aug. 4 2011

\bibitem{Mohamed} 
Mohamed, Bahaaeldin, and Thomas1 Koehler. ``The Effect Of Project Based Web 2.0-Learning On Students' Outcomes." \textit{Proceedings Of The IADIS International Conference On WWW/Internet} (2010): 253-258. Applied Science & Technology Source. Web. 8 Oct. 2015.

\bibitem{Seneviratna}
Seneviratna, G.A.D.P.S.; Nandasara, S.T., ``Web based project collaboration, monitoring and management system," in \textit{Advances in ICT for Emerging Regions (ICTer), 2014 International Conference} on , vol., no., pp.109-115, 10-13 Dec. 2014

\bibitem{{Wojtera}
Wojtera, M.; Sakowicz, B., ``Web Application For Project Management Based On Open Source Solutions," in \textit{Mixed Design of Integrated Circuits and System, 2006. MIXDES 2006. Proceedings of the International Conference} , vol., no., pp.797-800, 22-24 June 2006

\bibitem{{Galezowski}
Galezowski, G.; Zabierowski, W.; Napieralski, A., ``Web-based project management system," in \textit{CAD Systems in Microelectronics, 2009. CADSM 2009. 10th International Conference - The Experience of Designing and Application} , vol., no., pp.407-410, 24-28 Feb. 2009
...
\bibitem{swbook}
Tsui, Frank F., and Orlando Karam. \textit{Essentials of Software Engineering}. Sudbury, MA: Jones and Bartlett, 2007. Print.
