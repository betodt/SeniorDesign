...
\begin{tabularx}{\textwidth}{|X|X|X|}
    ...
    \par \textit{ Wojtera, M.; Sakowicz, B.} & The authors built a project management web application using open source solutions. & The authors uses JSP library to build their system, while my team is using Ember.js, which is a JavaScript framework.\\ 
    \hline
